...
namespace StorybrewScripts
{
    ...
    public class Playfield : IDisposable
    {
        ...
        public void initilizePlayField(StoryboardLayer receptors, StoryboardLayer notes, double starttime, double endtime, float initialWidht, float initialHeight, float receptorWallOffset, double OverallDifficulty, bool applyHitLight = true)
        {
            ...
            Column one = new Column(128, ColumnType.one, receptorSpritePath, receptors, receptorScale, starttime, delta, applyHitLight);
            Column two = new Column(256, ColumnType.two, receptorSpritePath, receptors, receptorScale, starttime, delta, applyHitLight);
            Column three = new Column(384, ColumnType.three, receptorSpritePath, receptors, receptorScale, starttime, delta, applyHitLight);
            Column four = new Column(512, ColumnType.four, receptorSpritePath, receptors, receptorScale, starttime, delta, applyHitLight);

            columns.Add(ColumnType.one, one);
            columns.Add(ColumnType.two, two);
            columns.Add(ColumnType.three, three);
            columns.Add(ColumnType.four, four);
