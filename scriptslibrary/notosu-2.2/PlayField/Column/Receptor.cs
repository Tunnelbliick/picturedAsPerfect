...
namespace StorybrewScripts
{
    public class Receptor
    {
        ...
        public Receptor(String receptorSpritePath, double rotation, StoryboardLayer layer, CommandScale scale, double starttime, ColumnType type, double delta, bool applyHitLight = true)
        {
        ...
        public Receptor(string receptorSpritePath, double rotation, StoryboardLayer layer, Vector2 position, ColumnType type, double delta, bool applyHitLight = true)
        {
